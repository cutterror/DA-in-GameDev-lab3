...
## Выводы
  ...
  Выполнив данную лабораторную работу, ознакомилась со средствами для создания системы машинного обучения Anaconda и её интеграции в Unity. Разобралась в основах MlAgent для Unity и изучила обучение модели на базовом примере.
